...
| Skill | 用途 | 关联失败记录 |
|:---|:---|:---|
| [`understand-gate/SKILL.md`](understand-gate/SKILL.md) | 入库理解门槛：AI 生成的代码 commit 前必须通过"逐段讲解 + 3 道理解测试题"，看不懂的代码不许入库 | `2026-09-14-understanding-gate.md`（已删，见 `docs/code_review_checklist.md`）、`2026-09-20-fwd-tb-understanding-gate.md`（理解门槛首轮不过的实例） |
